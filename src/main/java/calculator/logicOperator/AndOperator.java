...
public class AndOperator extends Operation {


    public final Map<String, Boolean> dictionary = new HashMap<>();
     ...
     */
    public AndOperator(List<Expression> expressionList) throws IllegalConstruction {
     ...
     * @return The result of the AND operation, or a new InvalidNumber if either input number is a InvalidNumber or either
    ...
    public MyNumber op(MyNumber l, MyNumber r) {
        ...
        try {
            if (l.getDoubleValue() > 1 || r.getDoubleValue() > 1){
                throw new LogicOperators.InvalidNumberException("Unexpected value: must be 0 or 1.");
            }
