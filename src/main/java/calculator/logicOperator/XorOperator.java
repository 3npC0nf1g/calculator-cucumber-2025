...
public class XorOperator extends Operation {
     ...
     */
    public XorOperator(List<Expression> expressionList) throws IllegalConstruction {
     ...
     * @return The result of the XOR operation, or a new InvalidNumber if either input number is a InvalidNumber or either
    ...
    public MyNumber op(MyNumber l, MyNumber r) {
        ...
        try {
            ...
            return new LogicOperators(value ? 1 : 0);
        }
