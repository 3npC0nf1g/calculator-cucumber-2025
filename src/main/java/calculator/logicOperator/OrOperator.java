...
public class OrOperator extends Operation {
     ...
     */
    public OrOperator(List<Expression> expressionList) throws IllegalConstruction {
     ...
     * @return The result of the OR operation, or a new InvalidNumber if either input number is a InvalidNumber or either
