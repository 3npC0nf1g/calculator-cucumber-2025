...
public class ImplyOperator extends Operation {
     ...
     */
    public ImplyOperator(List<Expression> expressionList) throws IllegalConstruction {
     ...
     * @return The result of the IMPLY operation, or a new InvalidNumber if either input number is a InvalidNumber or either
